...
export const projects = [
  ...
  {
    title: "web for the Gilgamesh University-موقع ويب لجامعة كلكامش ",
    description: "",
    tech: ["Next.js", "TypeScript", "Tailwind CSS"],
  ...
  {
    title: "Dyala Student ID Card Project",
    description:
      "Developing and issuing official ID cards for all Dyala students",
    tech: ["Next.js", "TypeScript", "Tailwind CSS"],
    image: "",
    github: "#",
    live: "#",
